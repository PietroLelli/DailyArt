...
public class FragmentFavourites extends Fragment implements OnItemListenerMuseum, OnItemListenerArtWork{
    ...
    TextView tvNoMuseumFavourites;
    TextView tvNoArtworkFavourites;


    MuseumCardAdapter adapterMuseum;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvNoMuseumFavourites=view.findViewById(R.id.tvNoFavouriteMuseum);
        tvNoArtworkFavourites=view.findViewById(R.id.tvNoFavouriteArtwork);
        ...
        dbRef.child("FavouriteMuseum").child(LoginActivity.loggedUser).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(museumList.isEmpty()){
                    tvNoMuseumFavourites.setVisibility(View.VISIBLE);
                }
                else{
                    tvNoMuseumFavourites.setVisibility(View.INVISIBLE);
                }*/
        ...
        dbRef.child("FavouriteArtwork").child(LoginActivity.loggedUser).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                /*if(artWorkList.isEmpty()){
                    tvNoArtworkFavourites.setVisibility(View.VISIBLE);
                }
                else{
                    tvNoArtworkFavourites.setVisibility(View.INVISIBLE);
                }*/
            }
